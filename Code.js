...
function playCraps() {
    ...
    //Says in console playcraps has started
    var die1;
    ...
    //Adding die1 + die2 to display the sum of both die
    document.getElementById("sumResults").innerHTML = "The sum of die1 plus die2 is: " + dieSum; //Shows the Su
    if (dieSum == 7 || dieSum == 11) {
        //If either die roll a 7 or 11 pop up the message below
        ...
        //die1 == die2 die2 % 2 == 0 is a test for evens
